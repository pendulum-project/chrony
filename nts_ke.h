...
#define NKE_RECORD_KEEP_ALIVE           8
#define NKE_RECORD_SUPPORTED_PROTOCOLS  9
#define NKE_RECORD_SUPPORTED_ALGORITHMS 10
#define NKE_RECORD_FIXED_KEY            12
#define NKE_RECORD_AUTH_TOKEN           14
